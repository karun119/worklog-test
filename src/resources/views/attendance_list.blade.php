...
<div class="attendance-list">
    ...
    <div class="month-switch">
        <a href="{{ route('attendance.list', ['month' => $prevMonth]) }}" class="month-prev">
        ...
        <div class="month-current">
            ...
            <a href="{{ route('attendance.list') }}"
                class="current-month-link month-decoration">
        ...
        <a href="{{ route('attendance.list', ['month' => $nextMonth]) }}" class="month-next">
                    ...
                    <td class="table-cell">
                        ...
                        <a class="detail-link"
                            href="{{ $attendance->id
                                ...
                                : route('attendance.detail', ['id' => 0, 'work_date' => $attendance->work_date->format('Y-m-d')])
                            }}">
                            詳細
                        </a>
                        @endif
